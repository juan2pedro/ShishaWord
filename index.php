        ...
        <div class="frame">
            ...
            <div ng-app ng-init="checked = false">
                <form class="form-signin" method="POST" name="form"> <label for="user">Usuario</label>
                    <input class="form-styling" type="text" name="user" placeholder="" value="<?= $user ?>" /> <label for="pas">Contraseña</label> <input class="form-styling" type="password" name="pas" placeholder="" value="<?= $pas ?>" /> <input type="checkbox" id="checkbox" />
                ...
                <form class="form-signup" method="POST" name="form">
                    ...
                    <label for="fecNan">Fecha de nacimiento</label> <input class="form-styling" type="date" name="fecNan" placeholder="" />
                    <label for="password">Contraseña</label> <input class="form-styling" type="password" name="password" placeholder="" /> <label for="confirmpassword">Confirmar contraseña</label> <input class="form-styling" type="password" name="confirmpassword" placeholder="" /> <a ng-click="checked = !checked" class="btn-signup">Registrarse</a>
